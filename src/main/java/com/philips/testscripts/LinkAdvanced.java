...
public class LinkAdvanced {
	...
	@Test
	public void testLinkingMultiFragment() {
		try {
			...
			CustomAssert.verifyEqual(resultMap.get("firstname").get(0), prop.getProperty("patient2NameGiven"));
			CustomAssert.verifyEqual(resultMap.get("lastname").get(0), prop.getProperty("patient2NameFamily"));
			//CustomAssert.verifyEqual(resultMap.get("gender"), prop.getProperty("patient2Gender"));
			CustomAssert.verifyEqual(resultMap.get("dob").get(0), prop.getProperty("patient2BirthTime"));
